...
class AnalyticsAndOnboardingTest extends TestCase
{
    ...
    public function test_widget_is_visible_for_user_with_vehicle_but_without_maintenance(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSeeText('Een korte omschrijving, datum en tellerstand zijn genoeg om te starten.')
    ...
    public function test_widget_shows_regular_dashboard_ctas_when_user_is_activated(): void
    {
        ...
        $this->actingAs($user)
            ->get('/admin')
            ->assertOk()
            ->assertSeeText('Je onderhoudshistorie is gestart')
            ->assertSeeText('Nog een onderhoudsbeurt toevoegen')
